...
if menu_id == "AllMetrics":
    ...
    ax.annotate(ksel1, (xsel1, ysel1+0.05), c='w', fontproperties=prop2, fontsize=10, zorder=4, ha='center', va='center')
    ax.annotate(ksel2, (xsel2, ysel2+0.05), c='w', fontproperties=prop2, fontsize=10, zorder=4, ha='center', va='center')
    ax.annotate(ksel3, (xsel3, ysel3+0.05), c='w', fontproperties=prop2, fontsize=10, zorder=4, ha='center', va='center')
