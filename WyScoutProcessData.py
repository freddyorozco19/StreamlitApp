...
if menu_id == "AllMetrics":
    ...
    with mainrow0:
        ...
        ax53 = fig.add_axes([0.85, -0.05, 0.05, 0.05])
...
if menu_id == "PlayerStats":
    ...
    colorradar1 = coloropt1
    colorradar2 = coloropt2
    alpharradar1 = 0.5
    alpharradar2 = 0.5
    ...
    ax.text(30, 5, playersel, color='w', fontsize=40, ha='center', va='center')
    ax.scatter(70, 5, s=600, color=colorradar2, marker='s')
    ax.text(70, 5, 'Promedio', color='w', fontsize=40, ha='center', va='center')
    st.pyplot(fig, bbox_inches="tight", pad_inches=0.05, dpi=600, format="png")
    st.markdown("""---""")        
